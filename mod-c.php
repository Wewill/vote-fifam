...
<html lang="fr">
	<head>
		...
		<title>Modifier une salle — FIFAM | Festival International du Film d'Amiens</title>
	</head>
	<body>
<?php include('header.php'); ?>
	...
	<br/>
	<small class="muted">Attention ! Je suis sur le point de modifier cette salle de la liste.</small>
	<br/><br/>
	<table>
