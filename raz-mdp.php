...
if ($vrif=="OK")
	...
	$msg.='<h2 style="color: #0066cc;">FIFAM - Réinitialisation du mot de passe</h2>';
	$msg.='<p>Bonjour '.$pnm.',</p>';
	...
	$msg.='<p style="margin: 20px 0;"><a href="https://vote.fifam.fr/mod-mdp.php?q='.$id.'&v='.$val.'" style="background-color: #0066cc; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block;">Réinitialiser mon mot de passe</a></p>';
	$msg.='<p>Ou copiez ce lien dans votre navigateur :<br/><span style="color: #0066cc;">https://vote.fifam.fr/mod-mdp.php?q='.$id.'&v='.$val.'</span></p>';
