...
include('BdD.php');
$men=0;
// Include edition number from database 
...
<html lang="fr">
	<head>
		...
		<meta name="keywords" content="FIFAM,Festival,International,Film,Amiens,<?php echo(date("Y")); ?>,vote,public" />
	...
	<br/>
	<h1>Bienvenue sur le site <br/>du vote du public <br/>du <?php echo(date("Y") - 1980); ?><sup>e</sup> Festival International<br/>du Film d'Amiens <?php echo(date("Y")); ?></h1>
	</article>
	</body>
</html>